...
export default function ZoomBlocksList({
  zoomBlocks,
  selectedBlock,
  onBlockClick,
  onDeleteBlock,
    ...
    <div className="bg-gray-100 p-4 rounded-lg h-[calc(100vh-200px)] overflow-y-auto">
      ...
      <div className="space-y-2">
        {zoomBlocks.map((block) => (
          <div
            key={block.id}
            className={`mb-2 p-2 bg-white rounded shadow text-black cursor-pointer ${
