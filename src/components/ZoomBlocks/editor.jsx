...
export default function ZoomBlockPanel({
  selectedBlock,
  onBlockUpdate,
  duration,
  isOpen,
  ...
  return (
    <div
      className={`fixed inset-y-0 right-0 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out min-w-[500px] ${
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onBlockUpdate({ ...selectedBlock, x: Number(e.target.value) })
              }
              min={0}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onBlockUpdate({ ...selectedBlock, y: Number(e.target.value) })
              }
              min={0}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black"
            />
